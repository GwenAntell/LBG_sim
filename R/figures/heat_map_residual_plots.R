...
FlatSim$SimSamp <- FlatSim$prop_richness - FlatSamp$prop_richness
FlatSim$SimRare <- FlatSim$prop_richness - FlatCR$prop_richness
...
UnimodalSim$SimSamp <- UnimodalSim$prop_richness - UnimodalSamp$prop_richness
UnimodalSim$SimRare <- UnimodalSim$prop_richness - UnimodalCR$prop_richness
...
BimodalSim$SimSamp <- BimodalSim$prop_richness - BimodalSamp$prop_richness
BimodalSim$SimRare <- BimodalSim$prop_richness - BimodalCR$prop_richness

#---------------------------------

FlatSimSamp <- ggplot() + 
  geom_tile(data = FlatSim, aes(x = mid_age, y = mid, fill = SimSamp, width = duration, height = 15), colour = "black") +
  scale_fill_viridis(option = "D", direction = 1, limits=c(-1, 1), breaks=seq(-1,1,by=0.25), labels = seq(-1,1,by=0.25)) +
  ...
  labs(x = "Time (Ma)", y = expression(bold(paste("Latitude (",degree,")"))), title = "Flat-type", subtitle = "Sampled") +
  theme(
...
FlatSimSamp <- FlatSimSamp + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Residual richness", title.position = "top", title.vjust = -5.5,  title.hjust = 0.5))
...
FlatSimRare <- FlatSimRare + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Residual richness", title.position = "top", title.vjust = -5.5,  title.hjust = 0.5))
...
UnimodalSimSamp <- ggplot() + 
  ...
  scale_x_reverse(expand=c(0,0), breaks = seq(0, 298.900, 50), limits = c(298.900, 3)) +
  coord_fixed(ratio = 0.8) +
  labs(x = "Time (Ma)", y = expression(bold(paste("Latitude (",degree,")"))), title = "Unimodal-type", subtitle = "Sampled") +
  theme(
    axis.text.x=element_text(size = 10, vjust = -2, angle = 0),
    axis.text.y=element_text(size = 10, hjust = 1, angle = 0),
    axis.title.x=element_text(size = 12, face = "bold", vjust = -4, colour = NA),
...
UnimodalSimSamp <- UnimodalSimSamp + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Residual richness", title.position = "top", title.vjust = -5.5,  title.hjust = 0.5))
...
UnimodalSimRare <- UnimodalSimRare + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Residual richness", title.position = "top", title.vjust = -5.5,  title.hjust = 0.5))
...
BimodalSimSamp <- ggplot() + 
  ...
  scale_x_reverse(expand=c(0,0), breaks = seq(0, 298.900, 50), limits = c(298.900, 3)) +
  coord_fixed(ratio = 0.8) +
  labs(x = "Time (Ma)", y = expression(bold(paste("Latitude (",degree,")"))), title = "Bimodal-type", subtitle = "Sampled") +
  theme(
    axis.text.x=element_text(size = 10, vjust = -2, angle = 0),
    axis.text.y=element_text(size = 10, hjust = 1, angle = 0),
    axis.title.x=element_text(size = 12, face = "bold", vjust = -4, colour = NA),
...
BimodalSimSamp <- BimodalSimSamp + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Residual richness", title.position = "top", title.vjust = -5.5,  title.hjust = 0.5))
...
BimodalSimRare <- BimodalSimRare + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Residual richness", title.position = "top", title.vjust = -5.5,  title.hjust = 0.5))
...
ggsave("./figures/heat_map_residual.png", plot = p, width = 280, height = 150, units = "mm", dpi = 300)
