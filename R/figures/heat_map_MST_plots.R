...
MST_plot <- MST_plot + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Summed minimum spanning tree length (km)", title.position = "top", title.hjust = 0.5, title.vjust = -9))

MST_plot

png("./figures/heat_map_mst.png",width = 210, height = 140, units = "mm", res = 600)
MST_plot
dev.off()
