...
ssc_plot <- ssc_plot + guides(fill = guide_colourbar(ticks.colour = "black", frame.colour = "black", label = TRUE, title = "Spatial sampling coverage (%)", title.position = "top", title.hjust = 0.5, title.vjust = -8))
